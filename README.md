...
## Problemas encontrados durante la configuración y despliegue, y cómo los solucionaste. Comparte el enlace al repositorio en la tarea del aula virtual.

El problemas era que no me cargaban las páginas desde el navegador del host. La solución fue crear reglas para apache y nginx para acceder a las páginas.
